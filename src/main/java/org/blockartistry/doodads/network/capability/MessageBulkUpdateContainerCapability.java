...
/**
 * Base class for messages that update the capability data for each slot of a
 * {@link Container}.
 * <p>
 * The {@link HANDLER} type must override {@link Object#equals(Object)} to
 * perform a value comparison and {@link Object#hashCode()} to generate a hash
 * code based on the values used in {@link Object#equals(Object)}.
 *
 * @param <HANDLER>
...
public abstract class MessageBulkUpdateContainerCapability<HANDLER, DATA> implements IMessage {
	...
	/**
	 * The capability data instances for each slot, indexed by their index in the
	 * original {@link List<ItemStack>}.
	 */
